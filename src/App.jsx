...
function App({ user, onLogout }) {
  ...
  const [chatHistory, setChatHistory] = useState([]);! 🏀 Je suis HoopIQ, ton analyste basket IA. Demande-moi une analyse de joueur, une prédiction de match, ou toute question basket.` }
  ]);
